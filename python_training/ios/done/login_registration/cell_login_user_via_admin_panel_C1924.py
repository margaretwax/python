...
class IosTest(unittest.TestCase):
    ...
    def test_untitled(self):
        ...
        click_and_send_keys(self.driver, "//UIAApplication[1]/UIAWindow[1]/UIATextField[1]", "0000009352")  # tap on login field and send login

        click_and_send_keys(self.driver, "//UIAApplication[1]/UIAWindow[1]/UIASecureTextField[1]", "123456")  # tap on password field and send password
