...
class IosTest(unittest.TestCase):
    ...
    def test_untitled(self):
        ...
        time.sleep(3)
        click_and_send_keys(self.driver, "//UIAApplication[1]/UIAWindow[1]/UIATextField[2]", "oorraa_test_ehgek@oorraa.com")  # tap on login field and send login

        click_and_send_keys(self.driver, "//UIAApplication[1]/UIAWindow[1]/UIASecureTextField[2]", "1234567")  # tap on password field and send password
